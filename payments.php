...
<div class="container"> <!--main -->
        ...
        <div class="panel panel-default">
          <div class="panel-heading" role="tab" id="headingOne">
            <h4 class="panel-title">
              <a id="one" role="button" data-toggle="false" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
            ...
            <div class="row"> 
              <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
                <div class="table-responsive"> 
                  ...
                  <tr id="next"><td colspan="5" align="right">
                    <input type="submit" value="next" name="next" class="btn-danger" id="nextbtn"/>
                  </td></tr>
                </tbody>
              </table>
            </div>
  ...
  <div  class="panel panel-default" >
    <div class="panel-heading" role="tab" id="headingTwo">
      <h4 class="panel-title">
        <a id="two" class="collapsed" role="button"   data-parent="#accordion" href="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
         <span class="glyphicon glyphicon-chevron-down"> </span> Login Option
       </a>
     </h4>
   </div>
   <div id="collapseTwo" class="collapse" role="tabpanel" aria-labelledby="headingTwo">
    <div id="paneltwo" class="panel-body">
      ...
      <input type="submit" value="Login" id="sendinvitation"  class="btn btn-danger"/>
    </form>
  </div>
</div>
</div>
<div   class="panel panel-default">
  <div class="panel-heading" role="tab" id="headingThree">
    <h4 class="panel-title">
      <a id="three" class="collapsed" role="button"  data-parent="#accordion" href="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
 ...
 <div id="collapseThree" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingThree">
  <div class="panel-body">
    ...
    if(qty > 0 && qty1<=0 &&qty2<=0 &&qty3<=0) 
      {$('#next').show();
  }
  else if(qty1 > 0 && qty<=0 &&qty2<=0 &&qty3<=0) 
    {$('#next').show();} 

  else if(qty2 > 0 && qty1<=0 &&qty<=0 &&qty3<=0) 
    {$('#next').show();} 

  else if(qty3 > 0 && qty1<=0 &&qty2<=0 &&qty<=0) 
    {$('#next').show();} 

  else if(qty > 0 || qty1 > 0 || qty2 > 0 || qty3 > 0)
    {$('#next').show();}
  ...
  else
    {
     ...
     $('#two').removeAttr("data-toggle"); 
      $('#three').removeAttr("data-toggle");
	 $('#one').removeAttr('data-toggle');  
	  }
    }
      ...
      $("#nextbtn").click(function(e){ 
       e.preventDefault(); 
      $('#two').attr('data-toggle','collapse'); 
      if($('#collapseTwo').collapse('show'))
        { 
           $('#one').attr('data-toggle','collapse');   
        }
    }); 

 $("#sendinvitation").click(function(ev){ 
 ev.preventDefault(); 
      $('#three').attr('data-toggle','collapse'); 
